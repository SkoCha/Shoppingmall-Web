...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">모든 상품평 관리 페이지</h3>
  </div>
    ...
    <div class="row">
        ...
        <div class="table-responsive">                
    				...
    				<tbody>
					    ...
					    <script>
					    	$("button[data-title='Delete']").click(function(){
					    		...
					    		if(conf) {
					    			$.ajax({
					    				url : "/admin/goods/replyList/" + target,
					    				type : "delete",
					    				success : function(result){
	                    					if(result) {
	                     					location.href = "/admin/goods/replyList";
	                    					} else {
            ...
            <div class="row">
				...
				<form id="actionForm" action="/admin/goods/replyList" method="get">
